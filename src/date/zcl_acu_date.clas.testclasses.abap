...
CLASS ltc_creation IMPLEMENTATION.
  ...
  METHOD given_date_then_kept.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( mid_june )->as_date( )
      exp = mid_june
  ...
  METHOD given_date_then_iso_rendered.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( mid_june )->as_iso( )
      exp = `2025-06-16`
  ...
  METHOD given_iso_then_parsed.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_iso( `2025-06-16` )->as_date( )
      exp = mid_june
  ...
  METHOD given_valid_then_confirmed.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>is_valid( mid_june )
      exp = abap_true
  ...
  METHOD given_feb_30_then_denied.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>is_valid( '20250230' )
      exp = abap_false
  ...
  METHOD given_month_13_then_denied.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>is_valid( '20251301' )
      exp = abap_false
  ...
  METHOD given_feb_30_then_rejected.
    TRY.
        zcl_acu_date=>for_date( '20250230' ).
  ...
  METHOD given_letters_then_rejected.
    TRY.
        zcl_acu_date=>for_date( '2025AB16' ).
  ...
  METHOD given_feb_29_leap_then_kept.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20240229' )->as_iso( )
      exp = `2024-02-29`
  ...
  METHOD given_feb_29_plain_rejected.
    TRY.
        zcl_acu_date=>for_date( '20250229' ).
  ...
  METHOD given_bad_sep_then_rejected.
    TRY.
        zcl_acu_date=>for_iso( `2025/06/16` ).
...
CLASS ltc_calendar_parts IMPLEMENTATION.
  ...
  METHOD given_date_then_parts_split.
    DATA(date) = zcl_acu_date=>for_date( '20250616' ).
  ...
  METHOD given_dates_then_quarters.
    cl_abap_unit_assert=>assert_equals( act = zcl_acu_date=>for_date( '20250101' )->quarter( )
                                        exp = 1
                                        msg = 'January does not fall into the first quarter' ).
    cl_abap_unit_assert=>assert_equals( act = zcl_acu_date=>for_date( '20250616' )->quarter( )
                                        exp = 2
                                        msg = 'June does not fall into the second quarter' ).
    cl_abap_unit_assert=>assert_equals( act = zcl_acu_date=>for_date( '20250731' )->quarter( )
                                        exp = 3
                                        msg = 'July does not fall into the third quarter' ).
    cl_abap_unit_assert=>assert_equals( act = zcl_acu_date=>for_date( '20251231' )->quarter( )
                                        exp = 4
  ...
  METHOD given_monday_then_weekday_1.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250616' )->weekday( )
      exp = 1
  ...
  METHOD given_sunday_then_weekday_7.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250615' )->weekday( )
      exp = 7
  ...
  METHOD given_pre_1900_then_weekday.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '18000101' )->weekday( )
      exp = 3
  ...
  METHOD given_date_then_day_of_year.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250616' )->day_of_year( )
      exp = 167
      msg = '16 June 2025 is not the 167th day of the year' ).
  ENDMETHOD.

  METHOD given_months_then_lengths.
    cl_abap_unit_assert=>assert_equals( act = zcl_acu_date=>for_date( '20250101' )->days_in_month( )
                                        exp = 31
                                        msg = 'January is not counted with 31 days' ).
    cl_abap_unit_assert=>assert_equals( act = zcl_acu_date=>for_date( '20250401' )->days_in_month( )
                                        exp = 30
                                        msg = 'April is not counted with 30 days' ).
    cl_abap_unit_assert=>assert_equals( act = zcl_acu_date=>for_date( '20250201' )->days_in_month( )
                                        exp = 28
  ...
  METHOD given_feb_leap_then_29_days.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20240201' )->days_in_month( )
      exp = 29
      msg = 'February of a leap year is not counted with 29 days' ).
  ENDMETHOD.

  METHOD given_years_then_leap_flag.
    cl_abap_unit_assert=>assert_equals( act = zcl_acu_date=>for_date( '20240101' )->is_leap_year( )
                                        exp = abap_true
                                        msg = '2024 is not recognised as a leap year' ).
    cl_abap_unit_assert=>assert_equals( act = zcl_acu_date=>for_date( '20250101' )->is_leap_year( )
                                        exp = abap_false
                                        msg = '2025 is wrongly recognised as a leap year' ).
    cl_abap_unit_assert=>assert_equals( act = zcl_acu_date=>for_date( '20000101' )->is_leap_year( )
                                        exp = abap_true
  ...
  METHOD given_century_then_not_leap.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '19000101' )->is_leap_year( )
      exp = abap_false
      msg = '1900 is wrongly recognised as a leap year' ).
  ENDMETHOD.

  METHOD given_sat_sun_then_weekend.
    cl_abap_unit_assert=>assert_equals( act = zcl_acu_date=>for_date( '20250614' )->is_weekend( )
                                        exp = abap_true
                                        msg = 'Saturday is not recognised as weekend' ).
    cl_abap_unit_assert=>assert_equals( act = zcl_acu_date=>for_date( '20250615' )->is_weekend( )
                                        exp = abap_true
  ...
  METHOD given_monday_then_no_weekend.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250616' )->is_weekend( )
      exp = abap_false
...
CLASS ltc_iso_week IMPLEMENTATION.
  ...
  METHOD given_new_year_then_week_1.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250101' )->iso_week( )
      exp = 1
  ...
  METHOD given_dec_30_then_week_1.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20241230' )->iso_week( )
      exp = 1
  ...
  METHOD given_dec_30_then_next_year.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20241230' )->iso_year( )
      exp = 2025
  ...
  METHOD given_dec_31_then_next_year.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20241231' )->iso_year( )
      exp = 2025
  ...
  METHOD given_jan_1_then_week_53.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20210101' )->iso_week( )
      exp = 53
  ...
  METHOD given_jan_1_then_prev_year.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20210101' )->iso_year( )
      exp = 2020
  ...
  METHOD given_mid_year_then_week_25.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250616' )->iso_week( )
      exp = 25
...
CLASS ltc_boundaries IMPLEMENTATION.
  ...
  METHOD given_date_then_month_start.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250616' )->first_day_of_month( )->as_iso( )
      exp = `2025-06-01`
  ...
  METHOD given_date_then_month_end.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250616' )->last_day_of_month( )->as_iso( )
      exp = `2025-06-30`
  ...
  METHOD given_feb_leap_then_29_end.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20240215' )->last_day_of_month( )->as_iso( )
      exp = `2024-02-29`
  ...
  METHOD given_date_then_quarter_start.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250616' )->first_day_of_quarter( )->as_iso( )
      exp = `2025-04-01`
  ...
  METHOD given_date_then_quarter_end.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250616' )->last_day_of_quarter( )->as_iso( )
      exp = `2025-06-30`
  ...
  METHOD given_date_then_year_start.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250616' )->first_day_of_year( )->as_iso( )
      exp = `2025-01-01`
  ...
  METHOD given_date_then_year_end.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250616' )->last_day_of_year( )->as_iso( )
      exp = `2025-12-31`
  ...
  METHOD given_sunday_then_week_start.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250615' )->first_day_of_week( )->as_iso( )
      exp = `2025-06-09`
  ...
  METHOD given_sunday_then_week_end.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250615' )->last_day_of_week( )->as_iso( )
      exp = `2025-06-15`
...
CLASS ltc_arithmetic IMPLEMENTATION.
  ...
  METHOD given_days_then_moved.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250616' )->add_days( 10 )->as_iso( )
      exp = `2025-06-26`
  ...
  METHOD given_neg_days_then_moved.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250601' )->add_days( -1 )->as_iso( )
      exp = `2025-05-31`
  ...
  METHOD given_max_date_then_rejected.
    TRY.
        zcl_acu_date=>for_date( '99991231' )->add_days( 1 ).
  ...
  METHOD given_jan_31_then_feb_28.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250131' )->add_months( 1 )->as_iso( )
      exp = `2025-02-28`
  ...
  METHOD given_jan_31_leap_then_feb29.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20240131' )->add_months( 1 )->as_iso( )
      exp = `2024-02-29`
  ...
  METHOD given_feb_28_then_mar_28.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250228' )->add_months( 1 )->as_iso( )
      exp = `2025-03-28`
  ...
  METHOD given_feb_28_ult_then_mar_31.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250228' )->add_months_ultimo( 1 )->as_iso( )
      exp = `2025-03-31`
  ...
  METHOD given_jan_31_ult_then_feb_28.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250131' )->add_months_ultimo( 1 )->as_iso( )
      exp = `2025-02-28`
  ...
  METHOD given_mid_ult_then_keeps_day.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250315' )->add_months_ultimo( 1 )->as_iso( )
      exp = `2025-04-15`
  ...
  METHOD given_neg_months_then_moved.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250315' )->add_months( -1 )->as_iso( )
      exp = `2025-02-15`
  ...
  METHOD given_neg_month_end_then_clamp.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250331' )->add_months( -1 )->as_iso( )
      exp = `2025-02-28`
  ...
  METHOD given_max_month_then_rejected.
    TRY.
        zcl_acu_date=>for_date( '99991231' )->add_months( 1 ).
  ...
  METHOD given_years_then_moved.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250616' )->add_years( 2 )->as_iso( )
      exp = `2027-06-16`
  ...
  METHOD given_leap_day_then_feb_28.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20240229' )->add_years( 1 )->as_iso( )
      exp = `2025-02-28`
  ...
  METHOD given_dates_then_day_gap.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250616' )->days_until( '20250626' )
      exp = 10
  ...
  METHOD given_earlier_then_neg_gap.
    cl_abap_unit_assert=>assert_equals(
      act = zcl_acu_date=>for_date( '20250616' )->days_until( '20250606' )
      exp = -10
